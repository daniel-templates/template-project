...
# $(call shell.print)
# $(info )
# $(info $(shell Write-Output 'Is this powershell? $xMyInvocation='; $xMyInvocation))
# $(info )
# $(call shell.names.bash.activate)
# $(call shell.print)
# $(info )
# $(info $(shell echo $(char.quot)Is this bash? $x0 -$x- $xSHELLOPTS $x* $(char.quot)))
# $(info )
...
# sep.path ?= /
# mkpath = $(subst /,$(sep.path),$(subst $(char.bsol),$(sep.path),$(call list.merge,$(sep.path),$1,$2,$3,$4,$5,$6,$7,$8)))
...
ifeq "$(SHELL_TYPE)" "CMD"
    ...
    shell.and = ( $(call str.concat,$(char.rparen) & $(char.lparen),$1,$2,$3,$4,$5,$6,$7,$8) )
